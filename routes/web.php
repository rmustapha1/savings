    ...
    Route::group(['middleware' => ['auth', 'verified']], function () {
        ...
        Route::group(['middleware' => ['Email2FA']], function () {
            ...
            Route::group(['middleware' => ['permission'], 'prefix' => 'admin'], function () {
                ...
                //for deposit account
                Route::get('savings_accounts/get_deposit_account_by_member_id/{member_id}', [SavingsAccountController::class, 'get_deposit_account_by_member_id']);
                // get_group_savings_account_by_member_id
                Route::get('savings_accounts/get_group_account_by_member_id/{member_id}', [SavingsAccountController::class, 'get_group_account_by_member_id']);
                // get_group_account_by_savings_account_id
                Route::get('savings_accounts/get_group_account_by_savings_account_id/{member_id}', [SavingsAccountController::class, 'get_group_account_by_savings_account_id']);
                ...
                //Groups
                Route::get('groups/get_table_data', [GroupController::class, 'get_table_data']);

                Route::resource('groups', GroupController::class);


                //Group Members
                Route::get('group_members/{group_id}', [GroupMemberController::class, 'index'])->name('group_members.index');
                Route::get('group_members/get_members_by_group/{group_id}', [GroupMemberController::class, 'getMembersByGroup']);
                Route::get('admin/group_members/get_table_data/{group}', [GroupMemberController::class, 'get_table_data'])
    ->name('group_members.get_table_data');
                Route::post('updatePayoutStatus/{id}', [GroupMemberController::class, 'updatePayoutStatus'])->name('group_members.updatePayoutStatus');

                Route::post('switchPayoutPosition/{id}', [GroupMemberController::class, 'switchPayoutPosition'])->name('group_members.switchPayoutPosition');
                

                Route::resource('group_members', GroupMemberController::class)->except(['index']);
                // resetContributionAndPayoutPosition route
                Route::post('admin/group_members/resetContributionAndPayoutPosition/{group_id}', [GroupMemberController::class, 'resetContributionAndPayoutPosition'])->name('group_members.resetContributionAndPayoutPosition');
                Route::get('admin/group_members/create/{group}', [GroupMemberController::class, 'create'])->name('group_members.create');
                Route::get('admin/group_members/get_payout_position_number/{group_id}', 
    [GroupMemberController::class, 'getPayoutPositionNumber']
)->name('group_members.get_payout_position_number');
