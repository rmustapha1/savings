    ...
    <div class="col-12">
        <div class="card">
                ...
                <div class="report-params">
                    <form class="validate" method="post" action="{{ route('reports.transactions_report') }}">
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control auto-select"
                                        data-selected="{{ isset($transaction_type) ? $transaction_type : old('transaction_type') }}"
                                        ...
                                        <option value="Account_Maintenance_Fee">{{ _lang('Account Maintenance Fee') }}
                                        </option>
                            ...
                            <div class="col-xl-2 col-lg-4">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Collected By') }}</label>
                            ...
                            <div class="col-xl-2 col-lg-4">
                                <button type="submit" class="btn btn-primary btn-xs btn-block mt-26"><i
            ...
            <div class="report-header">
                ...
                <h5>{{ isset($date1) ? date($date_format, strtotime($date1)).' '._lang('to').' '.date($date_format, strtotime($date2)) : '----------  '._lang('to').'  ----------' }}
                </h5>
            </div>
            ...
            <table class="table table-bordered report-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span
                                class="{{ $class }}">{{ $symbol.' '.decimalPlace($transaction->amount, currency($transaction->account->savings_type->currency->name)) }}</span>
                        </td>
                        ...
                        <td class="text-center"><a href="{{ route('transactions.show', $transaction->id) }}"
                                target="_blank" class="btn btn-outline-primary btn-xs">{{ _lang('View') }}</a></td>
                    </tr>
                    @endforeach
                    @endif
                </tbody>
