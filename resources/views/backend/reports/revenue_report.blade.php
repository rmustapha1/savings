	...
	<div class="col-12">
		<div class="card">
						...
						<div class="row">
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<select class="form-control auto-select" name="year"
										data-selected="{{ isset($year) ? $year : date('Y') }}" required>
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<select class="form-control auto-select" name="month"
										data-selected="{{ isset($month) ? $month : '' }}" required>
										<option value="0">{{ _lang('All Months') }}</option>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="form-control auto-select"
										data-selected="{{ isset($currency_id) ? $currency_id : base_currency_id() }}"
							...
							<div class="col-lg-3">
								<button type="submit" class="btn btn-primary btn-sm btn-block mt-26"><i
										class="icofont-filter"></i> {{ _lang('Filter') }}</button>
							</div>
					</form>
			...
			<div class="report-header">
				<h4>{{ _lang('Revenue Report') }}
					{{ isset($year) ? _lang('of').' '.($month == 0 ? _lang('All Months') : date('F', mktime(0, 0, 0, $month, 10))).' '.$year : '' }}
				</h4>
			</div>
