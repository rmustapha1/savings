	...
	<div class="col-lg-12">
		<div class="card no-export">
		    <div class="card-header d-flex align-items-center">
				...
				<!-- Withdraw Button -->
				<a class="btn btn-warning btn-xs ml-auto" href="{{ route('withdraw.manual_methods') }}"><i class="ti-plus"></i>&nbsp;{{ _lang('New Withdraw') }}</a>

				<!-- Deposit Button -->
				<a class="btn btn-primary btn-xs ml-3" href="{{ route('transactions.create') }}?type=deposit"><i class="ti-plus"></i>&nbsp;{{ _lang('New Deposit') }}</a>
			</div>
			<div class="card-body">
