...
<div class="row">
	...
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 bg-secondary dashboard-card">
			<div class="card-body">
				<div class="d-flex">
					<div class="flex-grow-1">
						<h5>{{ _lang('Balance') }}</h5>
						<h4 class="pt-1 mb-0"><b>{{ decimalPlace($balance) }}</b></h4>
					</div>
					<div>
						<a href="#"><i class="ti-arrow-right"></i>&nbsp;{{ _lang('View') }}</a>
					</div>
	...
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 bg-info dashboard-card">
			<div class="card-body">
				<div class="d-flex">
					<div class="flex-grow-1">
						<!-- <h5>/h5> -->
						<h5>{{ date('F')}} {{ _lang('Revenue') }}</h5>
						<h4 class="pt-1 mb-0"><b>{{ decimalPlace($total_monthly_charges) }}</b></h4>
					</div>
					<div>
						<a href="#"><i class="ti-arrow-right"></i>&nbsp;{{ _lang('View') }}</a>
					</div>
