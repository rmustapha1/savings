...
<li>
    <a href="javascript: void(0);"><i class="fas fa-user-friends"></i><span>{{ _lang('Members') }} {!!
            xss_clean($member_requests) !!}</span><span class="menu-arrow"><i
...
<li>
    <a href="javascript: void(0);"><i class="fas fa-users"></i><span>{{ _lang('Groups') }}</span><span
            class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
    <ul class="nav-second-level" aria-expanded="false">
        <li class="nav-item"><a class="nav-link" href="{{ route('groups.index') }}">{{ _lang('All Groups') }}</a></li>
    </ul>
</li>
...
<li>
    <a href="{{ route('transactions.create') }}?type=deposit"><i
            class="fas fa-money-check"></i><span>{{ _lang('Deposit Money') }}</span></a>
</li>

<li>
    <a href="{{ route('withdraw.manual_methods') }}"><i
            class="fas fa-money-check"></i><span>{{ _lang('Withdraw Money') }}</span></a>
</li>
<!-- <li>
